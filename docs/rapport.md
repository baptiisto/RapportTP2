...
### Expérience 1 : (10^6 nombre de points,Assignement 102)
...
### Expérience 2 : (10^7 nombre de points,Assignement 102)
| PI   | Difference | Error | Ntot      | AvailableProcessors | TimeDuration(ms) |
|------|------------|-------|-----------|---------------------|------------------|
|      |            |       | 160000000 | 1                   |                  |
|      |            |       | 160000000 | 1                   |                  |
...
### Expérience 3 : (10^8 nombre de points,Assignement 102)
| PI   | Difference | Error | Ntot       | AvailableProcessors | TimeDuration(ms) |
|------|------------|-------|------------|---------------------|------------------|
|      |            |       | 1600000000 | 1                   |                  |
|      |            |       | 1600000000 | 1                   |                  |
...
### Expérience 4 : (10^6 nombre de points, Pi.java)
| PI   | Difference | Error | Ntot     | AvailableProcessors | TimeDuration(ms) |
|------|------------|-------|----------|---------------------|------------------|
|      |            |       | 16000000 | 1                   |                  |
|      |            |       | 16000000 | 1                   |                  |
